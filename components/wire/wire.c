...
uint8_t 
I2Creadbyte( wire_t* wire, uint8_t device_addr, uint8_t reg_addr )
{
	uint8_t rd_data = 0;
...
uint8_t 
I2CreadBuff( wire_t* wire, uint8_t device_addr, uint8_t reg_addr, uint8_t* rd_buff, uint8_t length )
{
...
uint8_t 
I2Cwirtebyte( wire_t* wire, uint8_t device_addr, uint8_t reg_addr, uint8_t Data)
{
	i2c_cmd_handle_t cmd = i2c_cmd_link_create();
	esp_err_t ret;
    i2c_master_start(cmd);
...
uint8_t 
I2Cwirtebuff( wire_t* wire, uint8_t device_addr, uint8_t reg_addr, uint8_t* wd_buff,uint8_t length)
{
	i2c_cmd_handle_t cmd = i2c_cmd_link_create();
	esp_err_t ret;
    i2c_master_start(cmd);
...
uint8_t 
I2CbeginTransmission( wire_t* wire, uint8_t device_addr, uint8_t reg_addr )
{
